import{j as e,r as k}from"./vendor-DpISuAX6.js";import{r as t}from"./vendor-katex-CbWCYdth.js";import{D as _,T as w,E as v,P as M,N,W as A,b as C}from"./subject-01-foundations-D0A1VJsr.js";function I(){const[r,b]=k.useState(.5),[s,n]=k.useState(1),i=420,m=180,o=120,d=Array.from({length:o},(h,u)=>{const f=u/o,p=r*f*3,y=s*Math.sin(2*Math.PI*f*4),j=Math.sin(u*7.3)*.3+Math.cos(u*13.1)*.2;return p+y+j}),x=Math.min(...d)-.3,a=Math.max(...d)+.3,l=(h,u)=>`${h/o*i},${m-(u-x)/(a-x)*m}`,c=d.map((h,u)=>`${u===0?"M":"L"}${l(u,h)}`).join(" ");return e.jsxs("div",{className:"my-6 rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-900/50",children:[e.jsx("h3",{className:"mb-1 text-base font-bold text-gray-800 dark:text-gray-200",children:"Stationarity Explorer"}),e.jsxs("div",{className:"flex flex-wrap gap-4 mb-3",children:[e.jsxs("label",{className:"flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400",children:["Trend: ",r.toFixed(1),e.jsx("input",{type:"range",min:0,max:2,step:.1,value:r,onChange:h=>b(parseFloat(h.target.value)),className:"w-28 accent-violet-500"})]}),e.jsxs("label",{className:"flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400",children:["Seasonality: ",s.toFixed(1),e.jsx("input",{type:"range",min:0,max:3,step:.1,value:s,onChange:h=>n(parseFloat(h.target.value)),className:"w-28 accent-violet-500"})]})]}),e.jsx("svg",{width:i,height:m,className:"mx-auto block",children:e.jsx("path",{d:c,fill:"none",stroke:"#8b5cf6",strokeWidth:2})}),e.jsx("p",{className:"mt-2 text-center text-xs text-gray-500 dark:text-gray-400",children:r===0&&s===0?"✓ Approximately stationary (noise only)":"Non-stationary — has trend and/or seasonality"})]})}function B(){return e.jsxs("div",{className:"space-y-6",children:[e.jsx("p",{className:"text-gray-700 dark:text-gray-300 leading-relaxed",children:"Time series data consists of observations recorded sequentially over time. Before applying deep learning, understanding fundamental properties like stationarity, trend, and seasonality is critical for proper modeling and evaluation."}),e.jsxs(_,{title:"Stationarity",children:[e.jsxs("p",{children:["A time series ",e.jsx(t.InlineMath,{math:"X_t"})," is ",e.jsx("strong",{children:"strictly stationary"})," if its joint distribution is invariant to time shifts. In practice we use ",e.jsx("strong",{children:"weak stationarity"}),":"]}),e.jsx(t.BlockMath,{math:"\\mathbb{E}[X_t] = \\mu \\quad \\text{(constant)}, \\qquad \\text{Cov}(X_t, X_{t+h}) = \\gamma(h) \\quad \\text{(depends only on lag } h\\text{)}"})]}),e.jsxs(_,{title:"Autocorrelation Function (ACF)",children:[e.jsx(t.BlockMath,{math:"\\rho(h) = \\frac{\\gamma(h)}{\\gamma(0)} = \\frac{\\text{Cov}(X_t, X_{t+h})}{\\text{Var}(X_t)}"}),e.jsx("p",{className:"mt-2",children:"The ACF reveals repeating patterns, trend persistence, and seasonal cycles in the data."})]}),e.jsx(I,{}),e.jsxs(w,{title:"Classical Decomposition",id:"ts-decomposition",children:[e.jsx("p",{children:"Any time series can be decomposed into three components:"}),e.jsx(t.BlockMath,{math:"X_t = T_t + S_t + R_t"}),e.jsxs("p",{children:["where ",e.jsx(t.InlineMath,{math:"T_t"})," is the trend, ",e.jsx(t.InlineMath,{math:"S_t"})," is the seasonal component, and ",e.jsx(t.InlineMath,{math:"R_t"})," is the residual. A multiplicative variant uses ",e.jsx(t.InlineMath,{math:"X_t = T_t \\cdot S_t \\cdot R_t"}),"."]})]}),e.jsxs(v,{title:"Differencing for Stationarity",children:[e.jsx("p",{children:"First-order differencing removes a linear trend:"}),e.jsx(t.BlockMath,{math:"\\nabla X_t = X_t - X_{t-1}"}),e.jsxs("p",{children:["Seasonal differencing at period ",e.jsx(t.InlineMath,{math:"m"}),": ",e.jsx(t.InlineMath,{math:"\\nabla_m X_t = X_t - X_{t-m}"})]})]}),e.jsx(M,{title:"Stationarity Testing & Decomposition",code:`import numpy as np
...
print(f"Trend range: [{decomp.trend[~np.isnan(decomp.trend)].min():.2f}, "
      f"{decomp.trend[~np.isnan(decomp.trend)].max():.2f}]")`}),e.jsx(N,{type:"note",title:"Why Stationarity Matters for DL",children:e.jsxs("p",{children:["While deep learning models can implicitly learn trends and seasonality, making a series stationary before training often improves convergence and generalization. Many state-of-the-art models like N-BEATS apply ",e.jsx("strong",{children:"reversible instance normalization"})," — a learned form of stationarization."]})})]})}const he=Object.freeze(Object.defineProperty({__proto__:null,default:B},Symbol.toStringTag,{value:"Module"}));function z(){const[r,b]=k.useState(4),[s,n]=k.useState(2),i=[2.1,3.5,1.8,4.2,3.9,5.1,2.7,4.8,3.3,5.5,4.1,6],m=34,o=28,d=2,x=[];for(let a=0;a<=i.length-r-s;a++)x.push({start:a,inputEnd:a+r,targetEnd:a+r+s});return e.jsxs("div",{className:"my-6 rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-900/50",children:[e.jsx("h3",{className:"mb-1 text-base font-bold text-gray-800 dark:text-gray-200",children:"Sliding Window Visualization"}),e.jsxs("div",{className:"flex flex-wrap gap-4 mb-3",children:[e.jsxs("label",{className:"flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400",children:["Lookback: ",r,e.jsx("input",{type:"range",min:2,max:6,step:1,value:r,onChange:a=>b(parseInt(a.target.value)),className:"w-24 accent-violet-500"})]}),e.jsxs("label",{className:"flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400",children:["Horizon: ",s,e.jsx("input",{type:"range",min:1,max:4,step:1,value:s,onChange:a=>n(parseInt(a.target.value)),className:"w-24 accent-violet-500"})]})]}),e.jsx("div",{className:"overflow-x-auto",children:e.jsxs("svg",{width:i.length*(m+d)+10,height:x.length*(o+d)+o+10,children:[i.map((a,l)=>e.jsx("text",{x:l*(m+d)+m/2,y:14,textAnchor:"middle",className:"text-[10px] fill-gray-500",children:a},`h-${l}`)),x.map((a,l)=>e.jsx("g",{transform:`translate(0, ${l*(o+d)+22})`,children:i.map((c,h)=>{const u=h>=a.start&&h<a.inputEnd,f=h>=a.inputEnd&&h<a.targetEnd;return e.jsx("rect",{x:h*(m+d),y:0,width:m,height:o,rx:3,fill:u?"#8b5cf6":f?"#f97316":"#f3f4f6",opacity:u||f?.85:.25},h)})},l))]})}),e.jsxs("div",{className:"mt-2 flex gap-4 text-xs text-gray-500 dark:text-gray-400",children:[e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx("span",{className:"inline-block w-3 h-3 rounded bg-violet-500"})," Input window"]}),e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx("span",{className:"inline-block w-3 h-3 rounded bg-orange-500"})," Forecast horizon"]}),e.jsxs("span",{className:"ml-auto",children:[x.length," samples generated"]})]})]})}function D(){return e.jsxs("div",{className:"space-y-6",children:[e.jsx("p",{className:"text-gray-700 dark:text-gray-300 leading-relaxed",children:"Transforming a raw time series into supervised learning samples requires careful windowing. The choice of lookback length and forecast horizon directly affects what the model can learn and predict."}),e.jsxs(_,{title:"Sliding Window Transformation",children:[e.jsxs("p",{children:["Given a time series ",e.jsx(t.InlineMath,{math:"\\{x_1, \\ldots, x_T\\}"}),", lookback ",e.jsx(t.InlineMath,{math:"L"}),", and horizon ",e.jsx(t.InlineMath,{math:"H"}),":"]}),e.jsx(t.BlockMath,{math:"\\text{Input: } \\mathbf{x}_{t-L:t} = [x_{t-L}, \\ldots, x_{t-1}] \\;\\;\\to\\;\\; \\text{Target: } \\mathbf{y}_{t:t+H} = [x_t, \\ldots, x_{t+H-1}]"}),e.jsxs("p",{className:"mt-2",children:["This produces ",e.jsx(t.InlineMath,{math:"T - L - H + 1"})," training samples from a series of length ",e.jsx(t.InlineMath,{math:"T"}),"."]})]}),e.jsx(z,{}),e.jsxs(v,{title:"Lag Features",children:[e.jsx("p",{children:"Lag features augment each timestep with previous values as additional input dimensions:"}),e.jsx(t.BlockMath,{math:"\\mathbf{f}_t = [x_t, x_{t-1}, x_{t-7}, x_{t-14}, \\ldots]"}),e.jsx("p",{children:"Calendar features (day-of-week, month, holiday flags) provide exogenous context for seasonal patterns."})]}),e.jsx(A,{title:"Data Leakage in Time Series",children:e.jsxs("p",{children:["Never shuffle time series data randomly for train/test splits. Always use a temporal cutoff: train on ",e.jsx(t.InlineMath,{math:"[1, T_{\\text{train}}]"}),", validate on",e.jsx(t.InlineMath,{math:"(T_{\\text{train}}, T_{\\text{val}}]"}),", test on ",e.jsx(t.InlineMath,{math:"(T_{\\text{val}}, T]"}),". Normalization statistics must be computed ",e.jsx("strong",{children:"only from the training set"}),"."]})}),e.jsx(M,{title:"Creating Sliding Windows in PyTorch",code:`import torch
...
print(f"Naive baseline MAE: {mean_mae:.4f} +/- {std_mae:.4f}")`}),e.jsx(N,{type:"note",title:"Scaled Metrics for Cross-Series Comparison",children:e.jsxs("p",{children:["When comparing across series with different scales, use ",e.jsx("strong",{children:"MASE"})," (Mean Absolute Scaled Error), which normalizes by the in-sample naive forecast error. This makes MASE scale-independent: values below 1.0 indicate the model beats the naive baseline."]})})]})}const xe=Object.freeze(Object.defineProperty({__proto__:null,default:q},Symbol.toStringTag,{value:"Module"}));function W(){const[r,b]=k.useState(1),s=400,n=160,i=40,m=25,o=Array.from({length:i},(f,p)=>2*Math.sin(p*.3)+.5*Math.cos(p*.7)),d=-4,x=4,a=(f,p)=>`${f/i*s},${n-(p-d)/(x-d)*n}`,l=o.slice(0,m).map((f,p)=>`${p===0?"M":"L"}${a(p,f)}`).join(" "),c=o.slice(m-1).map((f,p)=>`${p===0?"M":"L"}${a(m-1+p,f+Math.sin(p*.2)*.2)}`).join(" "),h=o.slice(m-1).map((f,p)=>{const y=(m-1+p)/i*s,j=f+Math.sin(p*.2)*.2,g=r*(.3+p*.08);return{x:y,upper:n-(j+g-d)/(x-d)*n,lower:n-(j-g-d)/(x-d)*n}}),u=h.map((f,p)=>`${p===0?"M":"L"}${f.x},${f.upper}`).join(" ")+h.reverse().map(f=>`L${f.x},${f.lower}`).join(" ")+"Z";return e.jsxs("div",{className:"my-6 rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-900/50",children:[e.jsx("h3",{className:"mb-1 text-base font-bold text-gray-800 dark:text-gray-200",children:"Probabilistic Forecast"}),e.jsxs("label",{className:"flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-3",children:["Uncertainty scale: ",r.toFixed(1),e.jsx("input",{type:"range",min:.2,max:3,step:.1,value:r,onChange:f=>b(parseFloat(f.target.value)),className:"w-32 accent-violet-500"})]}),e.jsxs("svg",{width:s,height:n,className:"mx-auto block",children:[e.jsx("rect",{x:m/i*s,y:0,width:s-m/i*s,height:n,fill:"#8b5cf6",opacity:.05}),e.jsx("path",{d:u,fill:"#8b5cf6",opacity:.2}),e.jsx("path",{d:l,fill:"none",stroke:"#6b7280",strokeWidth:2}),e.jsx("path",{d:c,fill:"none",stroke:"#8b5cf6",strokeWidth:2}),e.jsx("line",{x1:m/i*s,y1:0,x2:m/i*s,y2:n,stroke:"#9ca3af",strokeDasharray:"4,3",strokeWidth:1}),e.jsx("text",{x:m/i*s+4,y:12,className:"text-[10px] fill-gray-400",children:"forecast"})]}),e.jsx("div",{className:"mt-2 flex justify-center gap-4 text-xs text-gray-500",children:e.jsx("span",{children:"Prediction intervals widen with horizon — reflecting growing uncertainty"})})]})}function F(){return e.jsxs("div",{className:"space-y-6",children:[e.jsx("p",{className:"text-gray-700 dark:text-gray-300 leading-relaxed",children:"DeepAR is an autoregressive RNN model that produces probabilistic forecasts by parameterizing a likelihood function at each time step. It learns across many related time series, sharing patterns via global parameters."}),e.jsxs(_,{title:"DeepAR Model",children:[e.jsxs("p",{children:["At each step ",e.jsx(t.InlineMath,{math:"t"}),", an LSTM computes hidden state ",e.jsx(t.InlineMath,{math:"h_t"})," and outputs distribution parameters:"]}),e.jsx(t.BlockMath,{math:"h_t = \\text{LSTM}(h_{t-1},\\; [x_{t-1},\\; \\mathbf{c}_t])"}),e.jsx(t.BlockMath,{math:"\\mu_t, \\sigma_t = \\text{MLP}(h_t), \\quad z_t \\sim \\mathcal{N}(\\mu_t, \\sigma_t^2)"}),e.jsxs("p",{className:"mt-2",children:["where ",e.jsx(t.InlineMath,{math:"\\mathbf{c}_t"})," contains covariates (time features, static embeddings)."]})]}),e.jsx(W,{}),e.jsxs(w,{title:"Negative Log-Likelihood Loss",id:"deepar-loss",children:[e.jsx("p",{children:"DeepAR is trained by maximizing the log-likelihood of the observed data:"}),e.jsx(t.BlockMath,{math:"\\mathcal{L} = -\\sum_{t=1}^{T} \\log p(x_t \\mid \\mu_t, \\sigma_t) = \\sum_{t=1}^{T}\\left[\\log \\sigma_t + \\frac{(x_t - \\mu_t)^2}{2\\sigma_t^2}\\right] + C"}),e.jsx("p",{children:"For count data, a negative binomial likelihood replaces the Gaussian."})]}),e.jsxs(v,{title:"Quantile Regression Alternative",children:[e.jsxs("p",{children:["Instead of parametric distributions, predict quantiles directly. The pinball loss for quantile ",e.jsx(t.InlineMath,{math:"q"}),":"]}),e.jsx(t.BlockMath,{math:"\\mathcal{L}_q(y, \\hat{y}) = \\begin{cases} q(y - \\hat{y}) & \\text{if } y \\geq \\hat{y} \\\\ (1-q)(\\hat{y} - y) & \\text{if } y < \\hat{y} \\end{cases}"})]}),e.jsx(M,{title:"DeepAR-Style Probabilistic Forecaster",code:`import torch
...
print("Zero-shot forecast: sample multiple trajectories -> quantile intervals")`}),e.jsx(N,{type:"note",title:"The Debate: Are TS Foundation Models Needed?",children:e.jsx("p",{children:"Unlike NLP where text has universal grammar, time series are highly domain-specific. Recent work shows simple baselines (linear models) can be competitive. Foundation models shine when labeled data is scarce, diverse series must be handled, or rapid prototyping is needed. The field is actively evolving."})})]})}const be=Object.freeze(Object.defineProperty({__proto__:null,default:U},Symbol.toStringTag,{value:"Module"}));function Q(){const[r,b]=k.useState(1.2),s=60,n=420,i=160,m=Array.from({length:s},(p,y)=>Math.sin(y*.3)+.3*Math.cos(y*.7)),o=[18,19,42,43,44],d=m.map((p,y)=>o.includes(y)?p+2.5:p),x=m.map((p,y)=>p+Math.sin(y*11.3)*.1),a=d.map((p,y)=>Math.abs(p-x[y])),l=-2,c=4,h=(p,y)=>`${p/s*n},${i*.6-(y-l)/(c-l)*i*.6}`,u=d.map((p,y)=>`${y===0?"M":"L"}${h(y,p)}`).join(" "),f=x.map((p,y)=>`${y===0?"M":"L"}${h(y,p)}`).join(" ");return e.jsxs("div",{className:"my-6 rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-900/50",children:[e.jsx("h3",{className:"mb-1 text-base font-bold text-gray-800 dark:text-gray-200",children:"Reconstruction-Based Anomaly Detection"}),e.jsxs("label",{className:"flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-3",children:["Threshold: ",r.toFixed(1),e.jsx("input",{type:"range",min:.3,max:3,step:.1,value:r,onChange:p=>b(parseFloat(p.target.value)),className:"w-28 accent-violet-500"})]}),e.jsxs("svg",{width:n,height:i,className:"mx-auto block",children:[e.jsx("path",{d:u,fill:"none",stroke:"#6b7280",strokeWidth:1.5}),e.jsx("path",{d:f,fill:"none",stroke:"#8b5cf6",strokeWidth:1.5,strokeDasharray:"4,3"}),a.map((p,y)=>{const j=y/s*n,g=p/3*40,T=p>r;return e.jsx("rect",{x:j,y:i-g,width:n/s-1,height:g,fill:T?"#ef4444":"#d1d5db",opacity:.7,rx:1},y)}),e.jsx("line",{x1:0,y1:i-r/3*40,x2:n,y2:i-r/3*40,stroke:"#ef4444",strokeWidth:1,strokeDasharray:"5,3"}),e.jsx("text",{x:n-4,y:i-r/3*40-4,textAnchor:"end",className:"text-[9px] fill-red-500",children:"threshold"})]}),e.jsxs("div",{className:"mt-2 flex justify-center gap-4 text-xs text-gray-500",children:[e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx("span",{className:"inline-block w-3 h-0.5 bg-gray-500"})," Original"]}),e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx("span",{className:"inline-block w-3 h-0.5 bg-violet-500",style:{borderBottom:"1px dashed"}})," Reconstructed"]}),e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx("span",{className:"inline-block w-3 h-3 bg-red-400 rounded"})," Anomaly"]})]})]})}function Y(){return e.jsxs("div",{className:"space-y-6",children:[e.jsx("p",{className:"text-gray-700 dark:text-gray-300 leading-relaxed",children:"Reconstruction-based anomaly detection trains an autoencoder on normal data. At inference, anomalies produce high reconstruction error because the model has never learned to reproduce abnormal patterns."}),e.jsxs(_,{title:"Reconstruction Error Anomaly Score",children:[e.jsxs("p",{children:["An autoencoder ",e.jsx(t.InlineMath,{math:"f_\\theta"})," maps a window ",e.jsx(t.InlineMath,{math:"\\mathbf{x}"})," to its reconstruction ",e.jsx(t.InlineMath,{math:"\\hat{\\mathbf{x}}"}),". The anomaly score is:"]}),e.jsx(t.BlockMath,{math:"a(\\mathbf{x}) = \\|\\mathbf{x} - f_\\theta(\\mathbf{x})\\|_2^2"}),e.jsxs("p",{className:"mt-2",children:["A point is flagged as anomalous if ",e.jsx(t.InlineMath,{math:"a(\\mathbf{x}) > \\tau"}),", where ",e.jsx(t.InlineMath,{math:"\\tau"})," is a threshold set on validation data."]})]}),e.jsx(Q,{}),e.jsxs(w,{title:"LSTM-Autoencoder Architecture",id:"lstm-ae",children:[e.jsx("p",{children:"The encoder LSTM compresses the input window into a fixed-size latent vector:"}),e.jsx(t.BlockMath,{math:"\\mathbf{z} = \\text{LSTM}_{\\text{enc}}(\\mathbf{x}_1, \\ldots, \\mathbf{x}_T) \\in \\mathbb{R}^d"}),e.jsxs("p",{children:["The decoder LSTM reconstructs the sequence from ",e.jsx(t.InlineMath,{math:"\\mathbf{z}"}),":"]}),e.jsx(t.BlockMath,{math:"\\hat{\\mathbf{x}}_t = \\text{MLP}(\\text{LSTM}_{\\text{dec}}(\\mathbf{z}, \\hat{\\mathbf{x}}_{t-1}))"})]}),e.jsx(v,{title:"Threshold Selection Strategies",children:e.jsxs("p",{children:["Common approaches: (1) fixed percentile (e.g., 99th) of training reconstruction errors, (2) mean + ",e.jsx(t.InlineMath,{math:"k\\sigma"})," of training errors, or (3) learned threshold via a small labeled validation set. Dynamic thresholds that adapt over time handle concept drift better than static ones."]})}),e.jsx(M,{title:"LSTM Autoencoder for Anomaly Detection",code:`import torch
import torch.nn as nn
...
print(f"Anomalous steps: {(error > threshold).sum().item()}")`}),e.jsx(N,{type:"note",title:"VAE for Richer Anomaly Scores",children:e.jsx("p",{children:"Variational autoencoders (VAEs) provide a principled anomaly score via the ELBO: both reconstruction error and KL divergence from the prior contribute. Points that map to unusual latent regions (high KL) are anomalous even if reconstruction appears acceptable."})})]})}const je=Object.freeze(Object.defineProperty({__proto__:null,default:Y},Symbol.toStringTag,{value:"Module"}));function Z(){const[r,b]=k.useState(2),s=50,n=400,i=150,m=Array.from({length:s},(j,g)=>{const T=Math.sin(g*.25)+.4*Math.cos(g*.6),S=g>=28&&g<=31?2.2:g===40?-1.8:0;return T+S}),o=m.map((j,g)=>Math.sin(g*.25)+.4*Math.cos(g*.6)),d=m.map((j,g)=>j-o[g]),x=Math.sqrt(d.reduce((j,g)=>j+g*g,0)/s),a=-3,l=4,c=(j,g)=>`${j/s*n},${i*.65-(g-a)/(l-a)*i*.65}`,h=m.map((j,g)=>`${g===0?"M":"L"}${c(g,j)}`).join(" "),u=o.map((j,g)=>`${g===0?"M":"L"}${c(g,j)}`).join(" "),f=o.map((j,g)=>c(g,j+r*x)),p=o.map((j,g)=>c(g,j-r*x)).reverse(),y=`M${f.join(" L")} L${p.join(" L")} Z`;return e.jsxs("div",{className:"my-6 rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-900/50",children:[e.jsx("h3",{className:"mb-1 text-base font-bold text-gray-800 dark:text-gray-200",children:"Forecast-Based Anomaly Detection"}),e.jsxs("label",{className:"flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-3",children:["Sensitivity (k-sigma): ",r.toFixed(1),e.jsx("input",{type:"range",min:1,max:4,step:.2,value:r,onChange:j=>b(parseFloat(j.target.value)),className:"w-28 accent-violet-500"})]}),e.jsxs("svg",{width:n,height:i,className:"mx-auto block",children:[e.jsx("path",{d:y,fill:"#8b5cf6",opacity:.1}),e.jsx("path",{d:u,fill:"none",stroke:"#8b5cf6",strokeWidth:1.5,strokeDasharray:"4,3"}),e.jsx("path",{d:h,fill:"none",stroke:"#374151",strokeWidth:1.5}),m.map((j,g)=>{if(!(Math.abs(d[g])>r*x))return null;const[S,L]=c(g,j).split(",");return e.jsx("circle",{cx:parseFloat(S),cy:parseFloat(L),r:4,fill:"#ef4444"},g)})]}),e.jsxs("div",{className:"mt-2 flex justify-center gap-4 text-xs text-gray-500",children:[e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx("span",{className:"inline-block w-3 h-0.5 bg-gray-700"})," Actual"]}),e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx("span",{className:"inline-block w-3 h-0.5 bg-violet-500"})," Forecast"]}),e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx("span",{className:"inline-block w-3 h-3 rounded-full bg-red-500"})," Anomaly"]})]})]})}function J(){return e.jsxs("div",{className:"space-y-6",children:[e.jsx("p",{className:"text-gray-700 dark:text-gray-300 leading-relaxed",children:"Forecasting-based anomaly detection compares model predictions with actual observations. Large prediction errors signal anomalous behavior. This approach naturally handles non-stationary data since the model learns to track normal dynamics."}),e.jsxs(_,{title:"Prediction Error Anomaly Score",children:[e.jsxs("p",{children:["Given a trained forecaster ",e.jsx(t.InlineMath,{math:"\\hat{x}_{t} = f_\\theta(x_{t-L:t-1})"}),", the anomaly score at time ",e.jsx(t.InlineMath,{math:"t"})," is:"]}),e.jsx(t.BlockMath,{math:"a_t = \\frac{|x_t - \\hat{x}_t|}{\\hat{\\sigma}_t}"}),e.jsxs("p",{className:"mt-2",children:["where ",e.jsx(t.InlineMath,{math:"\\hat{\\sigma}_t"})," is the estimated prediction uncertainty. Points with ",e.jsx(t.InlineMath,{math:"a_t > k"})," (e.g., ",e.jsx(t.InlineMath,{math:"k=3"}),") are anomalies."]})]}),e.jsx(Z,{}),e.jsxs(w,{title:"Conformal Prediction Intervals",id:"conformal-anomaly",children:[e.jsx("p",{children:"For calibrated anomaly detection, compute nonconformity scores on a calibration set:"}),e.jsx(t.BlockMath,{math:"s_i = |x_i - \\hat{x}_i|, \\quad i \\in \\mathcal{D}_{\\text{cal}}"}),e.jsxs("p",{children:["The prediction interval at level ",e.jsx(t.InlineMath,{math:"1-\\alpha"})," uses the ",e.jsx(t.InlineMath,{math:"\\lceil(1-\\alpha)(n+1)\\rceil/n"})," quantile of ",e.jsx(t.InlineMath,{math:"\\{s_i\\}"}),":"]}),e.jsx(t.BlockMath,{math:"C_t = [\\hat{x}_t - q_{1-\\alpha},\\; \\hat{x}_t + q_{1-\\alpha}]"}),e.jsxs("p",{children:["This guarantees ",e.jsx(t.InlineMath,{math:"P(x_t \\in C_t) \\geq 1-\\alpha"})," without distributional assumptions."]})]}),e.jsx(v,{title:"Multi-Step Forecast Residuals",children:e.jsxs("p",{children:["For multi-step forecasting, compute anomaly scores across the full horizon. An anomaly at step ",e.jsx(t.InlineMath,{math:"h"})," is weighted by the expected error at that horizon:",e.jsx(t.InlineMath,{math:"a_{t+h} = |x_{t+h} - \\hat{x}_{t+h}| / \\hat{\\sigma}_h"}),", where",e.jsx(t.InlineMath,{math:"\\hat{\\sigma}_h"})," grows with ",e.jsx(t.InlineMath,{math:"h"}),"."]})}),e.jsx(M,{title:"Conformal Anomaly Detection",code:`import torch
import numpy as np
...
print(f"Params: {sum(p.numel() for p in model.parameters()):,}")`}),e.jsx(N,{type:"note",title:"Benchmarking: UEA Archive",children:e.jsx("p",{children:"The UEA Multivariate Time Series Archive contains 30 benchmark datasets spanning domains like motion capture, medical sensors, and audio. When evaluating MTSC models, report critical difference diagrams across datasets rather than cherry-picking individual results. No single method dominates all datasets."})})]})}const we=Object.freeze(Object.defineProperty({__proto__:null,default:oe},Symbol.toStringTag,{value:"Module"}));export{me as a,xe as b,pe as c,fe as d,ue as e,ge as f,ye as g,be as h,je as i,_e as j,ke as k,ve as l,Me as m,we as n,he as s};
